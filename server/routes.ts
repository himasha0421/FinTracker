...
import { insertAccountSchema, insertTransactionSchema, insertFinancialGoalSchema } from "@shared/schema";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  router.get("/accounts", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error fetching accounts", error: String(error) });
    }
  });
  ...
  router.get("/accounts/:id", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error fetching account", error: String(error) });
    }
  });
  ...
  router.patch("/accounts/:id", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error updating account", error: String(error) });
    }
  });
  ...
  router.delete("/accounts/:id", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error deleting account", error: String(error) });
    }
  });
  ...
  router.get("/balance", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error fetching balance", error: String(error) });
    }
  });
  ...
  router.get("/transactions", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error fetching transactions", error: String(error) });
    }
  });
  ...
  router.get("/accounts/:id/transactions", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error fetching account transactions", error: String(error) });
    }
  });
  ...
  router.delete("/transactions/:id", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error deleting transaction", error: String(error) });
    }
  });
  ...
  router.get("/goals", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error fetching financial goals", error: String(error) });
    }
  });
  ...
  router.get("/goals/:id", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error fetching financial goal", error: String(error) });
    }
  });
  ...
  router.post("/goals", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error creating financial goal", error: String(error) });
    }
  });
  ...
  router.patch("/goals/:id", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error updating financial goal", error: String(error) });
    }
  });
  ...
  router.delete("/goals/:id", async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({ message: "Error deleting financial goal", error: String(error) });
    }
  });
