  ...
  const generateRecommendations = (
    ...
    if (totalBalance > 10000) {
      recommendations.push({
        ...
        description:
          'Maximize retirement contributions or explore tax-efficient investment options.',
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <Alert className="bg-blue-500/10 border-blue-500/20">
          ...
          <AlertDescription>
            Based on your financial data, we've generated the following recommendations to help
          ...
          <Card className="col-span-2">
            <CardContent className="pt-6 pb-6 text-center">
              ...
              <p className="text-muted-foreground">
                Based on your current financial data, we don't have any specific recommendations at
                this time. Continue monitoring your finances regularly.
              </p>
            </CardContent>
          </Card>
        )}
